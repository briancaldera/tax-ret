export interface LinkProps {
  ...
  type ComponentType = "blocks.hero-section" | "blocks.info-block" | "blocks.feature-article" | "blocks.subscribe";
  ...
  export interface FeaturedArticleProps extends Base<"blocks.feature-article"> {
    headline: string;
    excerpt: string;
    link: LinkProps;
    image: ImageProps;
